// import {css, define, Component, html, on, renderComplete, off, cache, render, show, getClosestComponent, getComponent} from '@pucelle/flit'
// import {theme} from '../style/theme'
// import {MouseLeave, align} from '@pucelle/ff'
...
// @define('f-menu')
// export class Menu<E = any> extends CommonMenu<E & MenuEvents> {
...
// 	protected onCreated() {
// 		this.root = this
// 		this.layer = getClosestComponent(this.el, Popup)
...
// 		}
// 		this.unwatchSubMenusLeave = MouseLeave.once(openedLayerEls, this.hideAllSubMenuLayers.bind(this))
// 	}
...
// 	static style() {
// 		let {adjustByLineHeight: lh, adjustByFontSize: fs} = theme
...
// 	static style() {
// 		let {adjustByLineHeight: lh, mainColor, layerBackgroundColor} = theme
...
// 		let iconSize = theme.adjustByLineHeight(25)
...
// 		this.parent = getClosestComponent(this.el, SubMenu) || getClosestComponent(this.el, Menu)!
// 		if (!this.parent) {
